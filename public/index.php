...
<body class="flex h-screen overflow-hidden">
    ...
    <!-- Sidebar Navegacion (Solo Desktop) -->
    <aside
    ...
    <main class="flex-1 flex flex-col h-full overflow-hidden relative">
        ...
        <header
            class="h-20 w-full flex items-center justify-between px-8 neon-border-b header-glass bg-surface/50 backdrop-blur-md z-10">
            <div class="flex-1 max-w-xl">
                <div class="relative">
                    ...
                    <input type="text" id="searchInput" placeholder="Buscar jugadores, juegos..."
                        class="block w-full pl-10 pr-3 py-2 border border-purple-500/25 rounded-full leading-5 bg-[#1f2937] text-white placeholder-gray-400 focus:outline-none focus:border-gamityPurple focus:ring-1 focus:ring-gamityPurple sm:text-sm transition-colors">
                </div>
            </div>
            ...
            <div class="ml-4 flex items-center gap-4">
                ...
                <div class="h-14 w-14 rounded-full bg-gradient-to-r from-gamityPurple to-gamityGreen p-[2px]">
                    <div
                        class="h-full w-full rounded-full bg-surface flex items-center justify-center font-bold text-sm text-white profile-initials overflow-hidden">
                        <img id="headerAvatar"
                            src="<?php echo htmlspecialchars($_SESSION['avatar'] ?? 'img/default.png'); ?>"
                            class="w-full h-full object-cover">
                        <span id="headerInitials"
                            class="hidden"><?php echo strtoupper(substr($_SESSION['username'], 0, 2)); ?></span>
                    </div>
                </div>
            </div>
        </header>
        ...
        <div class="flex-1 overflow-y-auto p-8 z-10" id="mainScroll">
            ...
            <div class="flex items-center mb-6">
                <h2 class="text-2xl font-bold flex items-center">
                    <svg class="w-6 h-6 mr-3 text-gamityPurple" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <span id="playerCount"
                    class="ml-4 px-3 py-1 bg-gamityPurple/20 text-gamityPurple text-xs rounded-full font-medium">0
                    jugadores</span>
            </div>

            <!-- Grid Cards -->
            <div id="usersGrid"
                class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 pb-24 md:pb-20">
                <div class="col-span-full flex justify-center items-center py-10 opacity-50">
                    <svg class="animate-spin -ml-1 mr-3 h-8 w-8 text-gamityPurple" xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="px-6 pb-6">
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex gap-3 pt-2">
                        <button id="modalChatBtn"
                            class="flex-1 py-2.5 rounded-xl bg-neon-gradient text-white font-bold hover:shadow-[0_0_20px_rgba(16,185,129,0.3)] transition-all flex items-center justify-center gap-2 text-sm">
        ...
        <div class="bg-surface rounded-2xl border border-white/5 w-full max-w-md mx-4 p-6 shadow-2xl">
            <div class="flex items-center gap-3 mb-5">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-400">Reportando a <span id="reportUsername"
                            class="text-red-400 font-semibold"></span></p>
                </div>
            </div>
            <form id="reportForm">
                ...
                <div class="flex gap-3">
                    ...
                    <button type="button" onclick="closeReportModal()"
                        class="px-5 py-2.5 rounded-xl border border-white/10 text-gray-400 hover:text-white hover:border-white/30 transition-all text-sm font-medium">Cancelar</button>
                </div>
            </form>
        </div>
    </div>
