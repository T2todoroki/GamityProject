        ...
        <div class="flex-1 overflow-y-auto p-8 pb-24 md:pb-8 relative z-10">
            <div class="max-w-3xl mx-auto">
                ...
                <div class="flex items-center justify-between mb-6">
                    ...
                    <a href="index.php" class="px-4 py-2 bg-gamityPurple text-white rounded-xl text-sm font-bold shadow-[0_0_15px_rgba(139,92,246,0.3)] hover:shadow-[0_0_25px_rgba(139,92,246,0.5)] hover:bg-gamityPurple/90 transition-all flex items-center gap-2">
