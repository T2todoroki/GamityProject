...
<body class="flex h-screen overflow-hidden">
    ...
    <main class="flex-1 flex flex-col relative overflow-hidden">
        ...
        <div
            class="absolute top-[20%] left-[20%] w-[500px] h-[500px] bg-gamityPurple rounded-full blur-[200px] opacity-10 pointer-events-none">
        </div>
        ...
        <header
            ...
            <button id="themeToggle"
                ...
                <svg id="themeIconDark" class="w-6 h-6 hidden" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div class="flex-1 overflow-y-auto p-8 pb-24 md:pb-8 relative z-10">
            <div class="max-w-3xl mx-auto">
                ...
                <div class="flex w-full bg-surfaceLight rounded-xl p-1 mb-8 overflow-hidden border border-white/5">
                    <button id="tabRequests"
                        class="flex-1 py-3 tab-btn tab-active rounded-lg flex items-center justify-center gap-2">
                    ...
                    <button id="tabFriends"
                        class="flex-1 py-3 tab-btn tab-inactive rounded-lg flex items-center justify-center gap-2">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div id="contentFriends" class="space-y-4 hidden">
                    ...
                    <div class="relative mb-6">
                        ...
                        <input type="text" id="searchFriendsInput" placeholder="Buscar amigo por nombre..."
                            class="block w-full pl-10 pr-3 py-2 border border-purple-500/25 rounded-full bg-[#1f2937] text-white placeholder-gray-400 focus:outline-none focus:border-gamityPurple focus:ring-1 focus:ring-gamityPurple text-sm transition-colors">
                    </div>
                    <div id="friendsListContainer" class="space-y-4">
